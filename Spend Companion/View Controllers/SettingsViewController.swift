...
// MARK:- Methods
    ...
    func buyiCloudSync() {
        let alertController = UIAlertController(title: "Purchase iCloud sync", message: "backup and sync your transactions across all devices signed in to iCloud for a one-time payment of 1.99 USD (or equivalent in local currency)", preferredStyle: .actionSheet)
